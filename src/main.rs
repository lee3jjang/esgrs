...
fn main() {
    ...
    let pswaption_mkt = [
        [0.2199, 0.4239, 0.6115, 0.9449, 1.2286, 1.5742],
        [0.3022, 0.5817, 0.8400, 1.2978, 1.6860, 2.1592],
        [0.3574, 0.6884, 0.9931, 1.5331, 1.9912, 2.5509],
        [0.4247, 0.8165, 1.1771, 1.8163, 2.3585, 3.0238],
        [0.4813, 0.9247, 1.3333, 2.0559, 2.6691, 3.4441],
        [0.5040, 0.9679, 1.3948, 2.1541, 2.8147, 3.6535],
    ];
    ...
    let mut sigma3 = 0.010098062217895592;
    let mut sigma5 = 0.008335104507121327;
    let mut sigma7 = 0.007841556073232338;
    let mut sigma10 = 0.007137430125778833;
    ...
    for _ in 0..10000 {
        ...
        println!("{:?}", (alpha, sigma1, sigma2, sigma3, sigma5, sigma7, sigma10));
    }
